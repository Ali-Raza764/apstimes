...
const Blog = () => {
  return (
    <div className="flex flex-col items-center justify-center w-[28rem] md:w-24 m-8 border-gray-200 shadow border-2 rounded-md p-4">
      ...
      <div className="">
        ...
        <a href="#" className="underline text-[#00604] italic">Read this post</a>
      </div>
    </div>
  );
};
