...
const Header = ({ loggedIn, authUser }) => {
  ...
  return (
    <div className="bg-white w-full h-max font-semibold border-b-2 border-gray-500 p-5 md:px-2 sm:py-3 flex justify-between">
      <div
      ...
      >
        ...
        <div className="ml-5 md:ml-2 text-2xl text-[#006435] flex">
